...
// Calendar component with working functionality
...
export default function OptimizedLegalDashboard() {
  ...
  const getStatusInfo = (status: string) => {
    switch (status.toLowerCase()) {
      ...
      case "case filed":
        return { variant: "outline" as const, icon: FileText, color: "text-gray-700" }
      case "site inspection done":
        return { variant: "secondary" as const, icon: CheckCircle2, color: "text-green-700" }
      default:
